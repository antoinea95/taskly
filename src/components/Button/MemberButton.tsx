...
export const MemberButton = ({
  ...
  const className =
    type === "tasks"
      ...
      : "flex items-center justify-start overflow-hidden rounded-xl w-12 p-0 hover:w-72 hover:justify-center transition-all duration-200";

  return (
    <Button onClick={() => setIsOpen(true)} className={`${className} animate-fade-in shadow-none hover:bg-gray-200 dark:bg-gray-800 dark:text-gray-300 dark:hover:bg-gray-600`} variant="secondary">
