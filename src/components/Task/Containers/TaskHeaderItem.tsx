...
export const TaskHeaderItem = ({
  ...
  return (
    <section className="flex flex-col md:px-3 gap-2">
      ...
      <div
        className={`flex items-center flex-wrap gap-2 max-w-96 bg-gray-50 rounded-xl w-fit px-3 py-2 min-h-12 dark:bg-gray-800 ${isAction ? "hover:bg-gray-200 dark:hover:bg-gray-600" : ""}`}
      >
        {children}
      </div>
    </section>
